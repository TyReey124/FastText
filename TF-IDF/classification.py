...
# лемматизация и приведение слов к нижнему регистру
...
def find_closest_questions(user_question, extra_threshold):
    ...
    # Нахождение ближайшего вопроса к заданному
...
def get_answers(user_question, extra_threshold, max_answers=7):
